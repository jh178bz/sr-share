...
Maker.create!(id: 1,
                 name: "Michelin",
                 image: File.open(Rails.root.join("public/images/maker/michelin.png")))

Maker.create!(id: 2,
                name: "Bridgestone",
                image: File.open(Rails.root.join("public/images/maker/bridgestone.png")))

Maker.create!(id: 3,
                name: "Dunlop",
                image: File.open(Rails.root.join("public/images/maker/dunlop.png")))

Maker.create!(id: 4,
                name: "Pirelli",
                image: File.open(Rails.root.join("public/images/maker/pirelli.jpeg")))

Maker.create!(id: 5,
                name: "Metzeler",
                image: File.open(Rails.root.join("public/images/maker/metzeler.jpg")))

Maker.create!(id: 6,
                name: "IRC",
                image: File.open(Rails.root.join("public/images/maker/irc.png")))
